...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b47ebfe88e2269101e1ab009325374d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("netkat.async", None);
                   ...
                   {
                      lib_modules = ["Gates_app"];
                      lib_pack = false;
                      lib_internal_modules = ["Maclist"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gates.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\001>\169X\238R\163F\186G\164\229\243Qo\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
